...
// @ts-ignore
import longBeyonder0000 from "@local-sql/api/db/migrations/0000_long_beyonder.sql" with {
  type: "file",
};
// @ts-ignore
import journalData from "@local-sql/api/db/migrations/meta/_journal.json" with {
  type: "file",
};
// @ts-ignore
import snapshot0000 from "@local-sql/api/db/migrations/meta/0000_snapshot.json" with {
  type: "file",
};
