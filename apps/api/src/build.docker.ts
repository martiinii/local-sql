...
// Build the API
await Bun.$`FORCE_COLOR=1 bun build index.ts --compile --external "@libsql/*" --external libsql --minify-whitespace --minify-syntax --target bun --outfile ../build-docker/server`;
